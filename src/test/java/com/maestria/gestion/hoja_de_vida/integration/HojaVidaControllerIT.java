...
class HojaVidaControllerIT {
    ...
    void obtenerHistoriaAcademicaRetornaResumenCompleto() throws Exception {
        mockMvc.perform(get("/api/hoja-vida/estudiantes/{codigo}/historia-academica", "2024001"))
                ...
                .andExpect(jsonPath("$.estudiante.estadoMaestria").value("ACTIVO"))
                .andExpect(jsonPath("$.estudiante.modalidadAcademica").value("INVESTIGACION"))
                .andExpect(jsonPath("$.estudiante.grupoInvestigacion.sigla").value("GTI"))
                .andExpect(jsonPath("$.estudiante.grupoInvestigacion.nombre")
                        .value("Grupo de I+D en Tecnologías de la Información"))
                ...
                .andExpect(jsonPath("$.historiaAcademica.investigacion.pasantias[0].lugarPasantia")
                        .value("Popayán, Cauca, Colombia"))
                .andExpect(jsonPath("$.historiaAcademica.investigacion.publicaciones[0].codigoPublicacion")
                        .value(1001))
                .andExpect(jsonPath("$.historiaAcademica.investigacion.publicaciones[0].nombreRevista")
                        .value("Revista de Tecnología"))
                .andExpect(jsonPath("$.historiaAcademica.investigacion.publicaciones[0].urlPublicacion")
                        .value("https://example.test/publicacion"))
                .andExpect(jsonPath("$.historiaAcademica.complementacion.practicasDocentes[0].fechaActa")
                        .value("2024-05-22"))
                .andExpect(jsonPath(
                        "$.historiaAcademica.complementacion.practicasDocentes[0].actividades[0].nombreActividad")
                        .value("Programación Orientada a Objetos"))
                .andExpect(jsonPath(
                        "$.historiaAcademica.complementacion.practicasDocentes[0].actividades[0].tipoActividad")
                        .value("DOCENCIA"))
                .andExpect(jsonPath(
    ...
    void obtenerHistoriaAcademicaSinInformacionAdicionalRetornaValoresPorDefecto() throws Exception {
        mockMvc.perform(get("/api/hoja-vida/estudiantes/{codigo}/historia-academica", "2022003"))
                ...
                .andExpect(jsonPath("$.estudiante.estadoMaestria").value(nullValue()))
                .andExpect(jsonPath("$.estudiante.modalidadAcademica").value(nullValue()))
                .andExpect(jsonPath("$.estudiante.grupoInvestigacion").value(nullValue()))
